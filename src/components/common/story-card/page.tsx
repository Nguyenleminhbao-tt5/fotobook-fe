        ...
        <li>
            {isStory==false? 
                <div className="h-[300px] shadow rounded-[15px] flex flex-col relative  hover:brightness-[80%]">
                    <img src={user?.avatar} className="h-[80%] rounded-t-[15px] bg-white" />
                ...
                <div className="h-[300px] shadow rounded-[15px] flex flex-col relative ">
                    <img src="./thumb/tếttết.jpg" className="w-full h-full rounded-[15px] transform scale-100 hover:scale-105 transition-transform hover:brightness-[80%]" />
