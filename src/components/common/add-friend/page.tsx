    ...
    return (
        <div className="flex items-center my-[20px] h-full">
            ...
            <div className="h-[70px] flex flex-col ms-4 justify-between ">
                ...
                <ul>
                    <Button  className="bg-[#0866FF] border-none text-white font-bold mr-[10px] h-[40px] w-[170px] text-[18px]">Xác nhận</Button>
                    <Button className="bg-[#3A3B3C] border-none text-white font-bold w-[170px] h-[40px] text-[18px]" >Xóa</Button>
                </ul>
            </div>
        </div>
    )
