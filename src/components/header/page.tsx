...
const Header = ({theme}: Props)=>{
    return (
        <header className={`${theme == "light" ? "bg-white": "bg-[#242526]"} h-[70px] w-full grid grid-cols-12  items-center border-[#8a8a8a] fixed z-[1000] `}>
            ...
            <section className="col-span-3 flex justify-self-end h-full items-center">
                <ul className="flex h-[50px]">
                   <li className="flex items-center justify-center rounded-full bg-[#3A3B3C] cursor-pointer w-[50px] mr-[10px] hover:brightness-125"> <TbGridDots className= "text-[30px]"/> </li> 
                   <li className="relative flex items-center justify-center rounded-full bg-[#3A3B3C] cursor-pointer w-[50px] mx-[10px] hover:brightness-125"> 
                        ...
                        <span className="bg-[#E41E3F] absolute top-[-5px] right-[-5px] w-[20px] h-[20px] rounded-full flex items-center justify-center">9</span> 
                    </li> 
                   <li className="relative flex items-center justify-center rounded-full bg-[#3A3B3C] cursor-pointer w-[50px] mx-[10px] hover:brightness-125"> 
                        <BsBellFill className= "text-[25px]" /> 
                        <span className="bg-[#E41E3F] absolute top-[-5px] right-[-5px] w-[20px] h-[20px] rounded-full flex items-center justify-center">6</span> 
                    </li> 
                   <li className="flex items-center justify-center rounded-full bg-[#3A3B3C] cursor-pointer w-[50px] mx-[10px] mr-5 hover:brightness-125"> <BiUserCircle className= "text-[30px]" /> </li> 
                </ul>
            </section>
        </header>
    )
